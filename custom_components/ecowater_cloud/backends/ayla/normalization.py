...
def normalize_device(
    ...
    capabilities = DeviceCapabilities(
        ...
        has_valve_reindex_count="valve_reindex_count" in props,
        has_valve_motor_state_enum="valve_motor_state_enum" in props,
        has_valve_pos_switch_enum="valve_pos_switch_enum" in props,
        has_valve_pos_time_left_secs="valve_pos_time_left_secs" in props,
        has_days_in_operation="days_in_operation" in props,
        has_total_untreated_water_gals="total_untreated_water_gals" in props,
        has_average_exhaustion_percent="average_exhaustion_percent" in props,
        has_efficiency_mode_enum="efficiency_mode_enum" in props,
        has_operating_capacity_grains="operating_capacity_grains" in props,
        has_hardness_grains="hardness_grains" in props,
        has_iron_level_tenths_ppm="iron_level_tenths_ppm" in props,
        has_flow_monitor_min_rate_gpm="flow_monitor_min_rate_gpm" in props,
        has_flow_monitor_trip_sec="flow_monitor_trip_sec" in props,
        has_manual_regens="manual_regens" in props,
        has_fill_secs="fill_secs" in props,
        has_backwash_secs="backwash_secs" in props,
        has_fast_rinse_secs="fast_rinse_secs" in props,
        has_second_backwash_cycles="second_backwash_cycles" in props,
        has_second_backwash_secs="second_backwash_secs" in props,
    )
    ...
    return EcoWaterDeviceData(
        ...
        power_outage_count=_safe_int(props.get("power_outage_count")),
        time_lost_events=_safe_int(props.get("time_lost_events")),
        longest_rec_outage_mins=_safe_int(props.get("longest_rec_outage_mins")),
        valve_reindex_count=_safe_int(props.get("valve_reindex_count")),
        valve_motor_state_enum=_safe_int(props.get("valve_motor_state_enum")),
        valve_pos_switch_enum=_safe_int(props.get("valve_pos_switch_enum")),
        valve_pos_time_left_secs=_safe_int(props.get("valve_pos_time_left_secs")),
        days_in_operation=_safe_int(props.get("days_in_operation")),
        total_untreated_water_gals=_safe_float(props.get("total_untreated_water_gals")),
        average_exhaustion_percent=_safe_float(props.get("average_exhaustion_percent")),
        efficiency_mode_enum=_safe_int(props.get("efficiency_mode_enum")),
        operating_capacity_grains=_safe_int(props.get("operating_capacity_grains")),
        hardness_grains=_safe_int(props.get("hardness_grains")),
        iron_level_tenths_ppm=_safe_int(props.get("iron_level_tenths_ppm")),
        flow_monitor_min_rate_gpm=_safe_float(props.get("flow_monitor_min_rate_gpm")),
        flow_monitor_trip_sec=_safe_int(props.get("flow_monitor_trip_sec")),
        manual_regens=_safe_int(props.get("manual_regens")),
        fill_secs=_safe_int(props.get("fill_secs")),
        backwash_secs=_safe_int(props.get("backwash_secs")),
        fast_rinse_secs=_safe_int(props.get("fast_rinse_secs")),
        second_backwash_cycles=_safe_int(props.get("second_backwash_cycles")),
        second_backwash_secs=_safe_int(props.get("second_backwash_secs")),
    )
